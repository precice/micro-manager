...
class TestFunctioncalls(TestCase):
    ...
    def test_micromanager_constructor(self):
        ...
        """
        manager = snapshot_computation.MicroManager('micro-manager-config.json')
    ...
    def test_config(self):
        ...
        """
        config = snapshot_computation.Config(MagicMock(), 'micro-manager-config.json')
