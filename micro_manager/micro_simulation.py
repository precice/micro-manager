...
def create_micro_problem_class(base_micro_simulation):
    ...
    class MicroSimulation(base_micro_simulation):
        ...
        def is_associated_to_inactive_sim(self, similar_inactive_local_id: int, similar_inactive_global_id: int) -> None:
        ...
        def is_associated_to_inactive_sims(self, similar_inactive_local_ids: list, similar_inactive_global_ids: list) -> None:
