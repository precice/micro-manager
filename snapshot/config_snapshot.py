"""
Class Config provides functionality to read a JSON file and pass the values to the Snapshot computation.
"""
...
class SnapshotConfig:
    ...
    def read_json(self, config_filename):
        ...
        try:
            if data["snapshot_params"]["postprocessing"]:
        ...
        try:
            if data["snapshot_params"]["merge_output"]:
